...
Constraints: every semantic status must be understandable without color; native SF symbols only; all text practical and legible; clear keyboard focus affordance; long paths truncate elegantly; no clipped controls; no proprietary branding.
